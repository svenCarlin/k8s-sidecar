...
| `REQ_SKIP_TLS_VERIFY`      | Set to `true` to skip tls verification for requests to `REQ_URL` and for `*.url` triggered requests                                                                                                                                                                                                                                 | false    | `false`                                   | boolean |
...
| `SKIP_TLS_VERIFY`          | Deprecate, use `KUBE_SKIP_TLS_VERIFY` instead. Set to `true` to skip tls verification for kube api calls                                                                                                                                                                                                                            | false    | -                                         | boolean |
| `KUBE_SKIP_TLS_VERIFY`     | Set to `true` to skip tls verification for kube api calls. Takes priority over `SKIP_TLS_VERIFY`                                                                                                                                                                                                                                    | false    | `false`                                   | boolean |
